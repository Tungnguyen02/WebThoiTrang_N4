...
<div class="grid__colum-10">
    <div class="home-filter">
        ...
        <select class="select-input_label" id="sort-box"
            ...
            <option <?php if(isset($_GET['sort']) && $_GET['sort'] == "asc") { ?> selected <?php } ?>
                value="Subpage.php?loaisanpham_id=<?php echo $resultj['loaisanpham_id'] ?>&field=sanpham_gia&sort=asc">
                Thấp đến Cao</option>
            <option <?php if(isset($_GET['sort']) && $_GET['sort'] == "desc") { ?> selected <?php } ?>
                value="Subpage.php?loaisanpham_id=<?php echo $resultj['loaisanpham_id'] ?>&field=sanpham_gia&sort=desc">
                Cao đến Thấp</option>
            <?php 
                            }
                        ?>
                ...
                <div class="home-product-item">
                    <a href="product.php?sanpham_id=<?php echo $resultB['sanpham_id']?>">
                        <div class="home-product-item_img"
                            style="background-image: url(admin/uploads/<?php echo $resultB['sanpham_anh']?>);"></div>
                    </a>
                    <a href="product.php?sanpham_id=<?php echo $resultB['sanpham_id']?>">
            ...
            <div class="grid__colum-2-4 grid__colum-fileOne">
                <div class="home-product-item">
                    <a href="product.php?sanpham_id=<?php echo $resultR['sanpham_id']?>">
                        <div class="home-product-item_img"
                            style="background-image: url(admin/uploads/<?php echo $resultR['sanpham_anh']?>);"></div>
                    </a>
                    <a href="product.php?sanpham_id=<?php echo $resultR['sanpham_id']?>">
                        <h4 class="home-product-item_name"><?php echo $resultR['sanpham_tieude']?></h4>
                    </a>
                    <div class="home-product-item_price">
                        <p style="font-size: 1.4rem; margin: 0 8px;"> Giá:</p>
                        <?php 
                        ...
                        <span class="home-product-item_price-old">
                            <?php $resultA = number_format($resultR['sanpham_gia']); echo $resultA?><sup>đ</sup></span>
                        <span
                            class="home-product-item_price-current"><?php $resultA = number_format($TGG); echo $resultA?><sup>đ</sup></span>
                        <?php 
                                       }else { ?>
                        <span
                            class="home-product-item_price-current"><?php $resultA = number_format($resultR['sanpham_gia']); echo $resultA?><sup>đ</sup></span>
                        <?php
                                        }
                                       ?>
                    </div>
    ...
    <ul class="pagination home-product_pagination">
        ...
        <li class="pagination-item ">
            <a href="Subpage.php?loaisanpham_id=<?php echo $resultj['loaisanpham_id'] ?>&<?=$param?>trang=<?php echo $i ?>"
                class="pagination-item_link"><?php echo $i ?></a>
        </li>
        <?php
                             }}
                          echo ' <li class="pagination-item">

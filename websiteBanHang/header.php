...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@200;300;400;500;700&display=swap"
        rel="stylesheet">
    ...
    <div class="row">
        <header>
            <div class="header-nav row">
                <div class="logo">
                    <a href="index.php"><img src="assets/img/image(1030).png" alt=""></a>
                </div>
                <div class="menu">
                    <?php
                    ...
                    <li><a href="#"><?php echo $result['danhmuc_ten'] ?></a>
                        <ul class="sub-menu">
                            <?php
                                    ...
                                    ?>
                            <li><a href="Subpage.php?loaisanpham_id=<?php echo $result['loaisanpham_id'] ?>"
                                    class="menu_li-a"><?php echo $result['loaisanpham_ten'] ?></a></li>
                ...
                <div class="others">
                    <li>
                        <form action="search.php" method="POST">
                            <input class="header__search-input" type="text" name="tukhoa"
                            ...
                            <div class="auth-form">
                                <div class="auth-form__container">
                                    <form action="" method="POST"
                                        onsubmit="if(password.value!=re_password.value)  {alert('Mật khẩu không đúng ! Vui lòng kiểm tra lại.'); return false;}">
                                        ...
                                        <div class="auth-form__form">
                                            <div class="auth-form__group">
                                                <input type="text" name="name" class="auth-form__input"
                                            ...
                                            <div class="auth-form__group">
                                                <input type="email" name="email" class="auth-form__input"
                                                    placeholder="Email:">
                                            </div>
                                            <div class="auth-form__group-select">
                                                ...
                                                ?>
                                                        <option value="<?php echo $result['ma_tinh'] ?>">
                                                            <?php echo $result['tinh_tp'] ?></option>
                                                        <?php
                                                 }}
                                                 ?>
                                                    </select>
                                            ...
                                            <div class="auth-form__group">
                                                <input type="text" name="address" class="auth-form__input"
                                                    placeholder="Địa chỉ:">
                                            </div>
                                            <div class="auth-form__group">
                                            ...
                                            <div class="auth-form__group">
                                                <input type="password" name="re_password" class="auth-form__input"
                                        ...
                                        <div class="auth-form__controls">
                                            <button id="register-close"
                                                class="btn btn--normal auth-form__controls-back ">TRỞ LẠI</button>
                            ...
                            <div class="auth-form">
                                <div class="auth-form__container">
                                    <form action="" method="POST">
                                        ...
                                        <div class="auth-form__form">
                                            <div class="auth-form__group">
                                                <input type="text" name="email" class="auth-form__input"
                                ...
                                if($show_cartF){while($result = $show_cartF->fetch_assoc()){
                                 ...
                                 ?>
                                    <li class="header__cart-item">
                                        <img src="<?php echo $result['sanpham_anh']  ?>" alt=""
                                            class="header__cart-img">
                                        <div class="header__cart-item-info">
                                            <div class="header__cart-item-head">
                                                <h5 class="header__cart-item-name">
                                                    <?php echo $result['sanpham_tieude']  ?></h5>
                                                <div class="header__cart-item-price-wrap">
                                                    <span
                                                        class="header__cart-item-price"><?php $resultC = number_format($result['sanpham_gia']); echo $resultC ?><sup>đ</sup></span>
                                                    <span class="header__cart-item-multiply">x</span>
                                                    <span
                                                        class="header__cart-item-qnt"><?php echo $result['quantitys']  ?></span>
                                                </div>
                                            </div>
                                            <div class="header__cart-item-body">
                                                <span class="header__cart-item-description">Màu sắc: <img
                                                        src="<?php echo $result['color_anh']  ?>" alt=""> </span>
                                                <span class="header__cart-item-remove">Size:
                                                    <?php echo $result['sanpham_size']  ?></span>
                                            </div>
                                        </div>
                                    </li>
                                    <?php

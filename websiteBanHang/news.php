                ...
                <div class="grid_new-6">
                    <div class="content-news">
                        <div class="news__title">
                            ...
                            <div class="time">25/03/2024</div>
                        </div>
                        <div class="news__content">
                            <p>Chào đón tháng 3 với hàng ngàn ưu đãi đặc biệt mà cửa hàng dành cho bạn. Đừng bỏ lỡ cơ
                                hội tham gia chương trình MUA 1 TẶNG 1 để sở hữu những món quà 0đ đầy hấp dẫn.</p>

                            <p><img src="assets/img/sli3.jpg" alt=""></p>
                            ...
                            <p>Bước 1: Tham khảo và chọn mua sản phẩm nguyên giá&nbsp;(có giá bán lẻ không khuyến mại)
                            </p>

                            <p>Bước 2: Thêm ngay&nbsp;sản phẩm tặng kèm vào giỏ hàng, với điều kiện giá gốc sản phẩm
                                tặng kèm có giá trị thấp hơn hoặc bằng&nbsp;sản phẩm chính.</p>

                            <p>Bước 3: Thanh toán&nbsp;cho sản phẩm nguyên giá và nhận sản phẩm tặng kèm miễn phí 0đ.
                            </p>

                            <h3>Lưu ý:</h3>

                            <p>- Chương trình mua 1 tặng 1 <strong>áp dụng cho sản phẩm nguyên giá</strong> và không áp
                                dụng cho các sản phẩm khác có giá khuyến mại.</p>

                            <p>- <strong>Giá gốc&nbsp;của&nbsp;sản phẩm tặng kèm&nbsp;có giá trị thấp hơn hoặc
                                    bằng</strong>&nbsp;giá sản phẩm chính đã chọn.</p>

                            <p>- <strong>Mua càng nhiều, ưu đãi càng lớn</strong>: Số lượng sản phẩm tặng kèm tương ứng
                                với sản phẩm chính được mua</p>

                            <p>Hãy ghé ngay <a href="index.php">Website</a> của shop để khám phá thêm về chương trình
                                ưu đãi hấp dẫn này nhé!</p>
                        </div>
        ...
        <div class="row">
            <div class="product-gallery-one-content">
                <div class="product-gallery-one-content-title product-gallery-two-block">
                    <h1 class="product-gallery-ones-h1"> MUA 1 ĐƯỢC 2</h1>
                            ...
                            <div class="home-product-item">
                                <a href="product.php?sanpham_id=<?php echo $resultB['sanpham_id']?>">
                                    <div class="home-product-item_img"
                                        style="background-image: url(admin/uploads/<?php echo $resultB['sanpham_anh']?>);">
                                    </div>
                                </a>
                                <a href="product.php?sanpham_id=<?php echo $resultB['sanpham_id']?>">
                                ...
                                <div class="home-product-item_price">
                                    ...
                                    <span class="home-product-item_price-old">
                                        <?php $resultA = number_format($resultB['sanpham_gia']); echo $resultA?><sup>đ</sup></span>
                                    <span
                                        class="home-product-item_price-current"><?php $resultA = number_format($TGG); echo $resultA?><sup>đ</sup></span>
                                    <?php 
                                       }else { ?>
                                    <span
                                        class="home-product-item_price-current"><?php $resultA = number_format($resultB['sanpham_gia']); echo $resultA?><sup>đ</sup></span>
                                    <?php
                                        }
                                       ?>
                                </div>
                                ...
                                <div class="home-product-item_origin">
                                    <span class="home-product-item_brand">MEN</span>
                                    <span class="home-product-item_origin-name">HCM</span>
                                </div>
